...
FCKConfig.Plugins.Add( 'Acronym','zh-cn') ;
FCKConfig.Plugins.Add( 'autogrow') ;
//FCKConfig.Plugins.Add( 'bbcode') ;
FCKConfig.Plugins.Add( 'dragresizetable') ;
//FCKConfig.Plugins.Add( 'FileIcon','zh-cn') ;
FCKConfig.Plugins.Add( 'geckospellchecker') ;
//FCKConfig.Plugins.Add( 'googlemaps','zh-cn') ;
//FCKConfig.Plugins.Add( 'HtmlTiles','zh-cn') ;
FCKConfig.Plugins.Add( 'imgmap','zh-cn') ;
...
FCKConfig.Plugins.Add( 'paypal','zh-cn') ;
//FCKConfig.Plugins.Add( 'placeholder','en') ;
//FCKConfig.Plugins.Add( 'RemoteUpload','zh-cn') ;
FCKConfig.Plugins.Add( 'simplecommands') ;
FCKConfig.Plugins.Add( 'skype','zh-cn') ;
FCKConfig.Plugins.Add( 'symbol','zh-cn') ;
...
FCKConfig.ToolbarSets["Default"] = [
	...
	['OrderedList','UnorderedList','-','Outdent','Indent','Blockquote','CreateDiv','ShowBlocks'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Anchor'],
	['Image','imgmapPopup','Flash','Media','YouTube','Movie'/*,'Smiley','SpecialChar','PageBreak'*/],
	'/',
	//[/*'bbcode','FileIcon','googlemaps','HtmlTiles','Insertplayer','KMP','placeholder','RemoteUpload'*/],
	//'/',
	['Style','FontFormat','FontName','FontSize'],
	['Table','Rule','Acronym','InsertCode','paypal','My_Skype','symbol','-','FitWindow','-','About']		// No comma for the last row.
] ;
...
FCKConfig.MediaUploadAllowedExtensions	= ".(swf|flv|wma|avi|wmv|mov)$" ;		// empty for all
