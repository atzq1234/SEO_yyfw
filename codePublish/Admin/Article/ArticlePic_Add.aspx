<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArticlePic_Add.aspx.cs" Inherits="HxSoft.Web.Admin.Article.ArticlePic_Add" %>
    ...
    <script language="javascript" type="text/javascript">
        $(function () {
            $("#btUpload1").click(function () {
                dialog("上传文件", "iframe:../Upload/File_Upload_Dialog.aspx?ObjName=txtSmallPic&FolderPath=<%=Config.FileUploadPath %>Article/", "650px", "550px", "");
            });
            $("#btSelect1").click(function () {
                dialog("选择文件", "iframe:../Upload/File_Select_Dialog.aspx?ObjName=txtSmallPic&FolderPath=<%=Config.FileUploadPath %>Article/", "650px", "550px", "");
            });
            ...
            $("#btUpload2").click(function () {
                dialog("上传文件", "iframe:../Upload/File_Upload_Dialog.aspx?ObjName=txtBigPic&FolderPath=<%=Config.FileUploadPath %>Article/", "650px", "550px", "");
            });
            $("#btSelect2").click(function () {
                dialog("选择文件", "iframe:../Upload/File_Select_Dialog.aspx?ObjName=txtBigPic&FolderPath=<%=Config.FileUploadPath %>Article/", "650px", "550px", "");
            });
    ...
    <div id="container">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_form">
            <tr class="table_form_title">
                <td colspan="4">
                    <asp:Label ID="lblTitle" runat="server">添加</asp:Label>图片
                </td>
            </tr>
