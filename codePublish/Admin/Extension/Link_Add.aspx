<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Link_Add.aspx.cs" Inherits="HxSoft.Web.Admin.Extension.Link_Add" %>
    ...
    <script language="javascript" type="text/javascript">
        $(function () {
            $("#btUpload1").click(function () {
                dialog("上传文件", "iframe:../Upload/File_Upload_Dialog.aspx?ObjName=txtLogoUrl&FolderPath=<%=Config.FileUploadPath %>Link/", "650px", "550px", "");
            });
            $("#btSelect1").click(function () {
                dialog("选择文件", "iframe:../Upload/File_Select_Dialog.aspx?ObjName=txtLogoUrl&FolderPath=<%=Config.FileUploadPath %>Link/", "650px", "550px", "");
            });
            $("#btPreview1").click(function () {
                dialog("图片预览", "iframe:../Upload/File_Preview.aspx?FilePath=" + $("#txtLogoUrl").val(), "500px", "300px", "");
            });
        });
    </script>
</head>
    ...
    <div id="container">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_form">
            ...
            <tr class="table_form_row">
                ...
                <td>
                    <asp:DropDownList ID="drpConfigID" runat="server" AutoPostBack="True" >
                    </asp:DropDownList>
            ...
            <tr class="table_form_row">
                ...
                <td>
                    <asp:RadioButtonList ID="radTypeID" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" AutoPostBack="True" OnSelectedIndexChanged="radTypeID_SelectedIndexChanged">
            ...
            <tr class="table_form_row">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSiteName" Display="Dynamic" ErrorMessage="不能为空" SetFocusOnError="True"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr class="table_form_row">
                <td style="width: 15%" align="right">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtSiteUrl" Display="Dynamic" ErrorMessage="不能为空" SetFocusOnError="True"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr class="table_form_row">
                <td style="width: 15%" align="right">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtLogoUrl" Display="Dynamic" ErrorMessage="不能为空" SetFocusOnError="True"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr class="table_form_row">
                <td style="width: 15%" align="right">
