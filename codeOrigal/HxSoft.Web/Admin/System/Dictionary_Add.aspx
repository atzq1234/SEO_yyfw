<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dictionary_Add.aspx.cs" Inherits="HxSoft.Web.Admin._System.Dictionary_Add" %>
    ...
    <div id="container">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_form">
            ...
            <tr class="table_form_row">
                ...
                <td>
                    <asp:TextBox ID="txtDictionaryName" runat="server" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDictionaryName" Display="Dynamic" ErrorMessage="不能为空" SetFocusOnError="True"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr class="table_form_row">
                <td style="width: 15%" align="right">
                ...
                <td>
                    <asp:TextBox ID="txtDictionaryVal" runat="server" />
                </td>
            </tr>
            <tr class="table_form_row">
                <td style="width: 15%" align="right">
