...
{
    public partial class Product_Transfer : System.Web.UI.Page
    {
        /// <summary>
        /// 创建人:杨小明
        /// 日期:2010-12-6
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            GetData.LimitChkMsg("ProductTransfer");
            if (!Page.IsPostBack)
            {
                //产品分类
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < arrProductID.Length; i++)
            {
                ...
                if (proModel != null)
                {
                    ...
                    {
                        Factory.Product().TransferInfo(arrProductID[i],strClassID);
            ...
            if (n > 0)
            {
                Factory.AdminLog().InsertLog("转移编号为" + strTempProductID.ToString() + "的产品!", Session["AdminID"].ToString());
                Config.MsgGotoUrl("编号为" + strTempProductID.ToString() + "的产品转移成功!", "Product.aspx?" + UrlOrderPara + UrlPara + "page=" + page.ToString());
            }
            else
            {
