...
{	
	...
	if( sMp3Url.length> 0) {
		...
		sAutioPlay ="<object id=\"audioplayer"+numTemp+"\" data=\"common/player.swf\" width=\"290\" height=\"24\" type=\"application/x-shockwave-flash\">"+"<param value=\"common/player.swf\" name=\"movie\" />"+"<param value=\"playerID="+numTemp+"&amp;bg=0xCDDFF3&amp;leftbg=0x357DCE&amp;lefticon=0xF2F2F2&amp;rightbg=0xF06A51&amp;rightbghover=0xAF2910&amp;righticon=0xF2F2F2&amp;righticonhover=0xFFFFFF&amp;text=0x357DCE&amp;slider=0x357DCE&amp;track=0xFFFFFF&amp;border=0xFFFFFF&amp;loader=0xAF2910&amp;"+musicTitles+musicArtists+sAutoStart+sLoop+alwayOpen+"soundFile="+sMp3Url+"\" name=\"FlashVars\" /><param value=\"high\" name=\"quality\" /><param value=\"false\" name=\"menu\" /><param value=\"transparent\" name=\"wmode\" />"+"</object>";
