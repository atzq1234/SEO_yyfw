...
<!--#include file="../../filemanager/connectors/asp/function.asp"-->
<%
Dim sMyXmlDoc, sMyXmlHTTP, ConfigSavePath, D_Name, FSO
D_Name = "month_"&DateToStr(Now(), "ym")
Set FSO = Server.CreateObject("Scripting.FileSystemObject")
If FSO.FolderExists(Server.MapPath("/Files/UploadFiles/"&D_Name)) = False Then
	FSO.CreateFolder Server.MapPath("/Files/UploadFiles/"&D_Name)
End If
ConfigSavePath = "/Files/UploadFiles/"&D_Name&"/"
DealResponse()
Sub DealResponse()
