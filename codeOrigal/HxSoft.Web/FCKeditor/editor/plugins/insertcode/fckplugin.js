FCKCommands.RegisterCommand('InsertCode',new FCKDialogCommand( 'InsertCode', FCKLang["InsertCodeBtn"], FCKPlugins.Items['InsertCode'].Path + 'fck_insertcode.html', 580, 420 ) ) ;
var oInsertCode=new FCKToolbarButton('InsertCode',FCKLang["InsertCodeBtn"],FCKLang["InsertCodeBtn"]);

oInsertCode.IconPath	= FCKConfig.PluginsPath + 'InsertCode/InsertCode.gif' ;
