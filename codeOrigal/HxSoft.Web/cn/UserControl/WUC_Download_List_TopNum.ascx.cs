...
{
    public partial class WUC_Download_List_TopNum : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select " + strSqlTop + " * from t_Download where IsClose=0 " + strSql.ToString() + " order by " + OrderField + " " + OrderKey + " " + strMySqlTop;
