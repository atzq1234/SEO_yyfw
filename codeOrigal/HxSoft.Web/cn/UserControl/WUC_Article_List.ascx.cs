...
{
    public partial class WUC_Article_List : System.Web.UI.UserControl
    {
        #region ****属性****
        ...
        public string SqlQuery
        {
            get
            {
                ...
                if (SearchKey != "")
                {
                    TempSql.Append(" and Title like @SearchKey");
                }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //列表绑定
            string sql = "select " + strSqlTop + " * from t_Article where IsClose=0 " + SqlQuery + " order by " + OrderField + " " + OrderKey + " " + strMySqlTop;
