...
{
    public partial class WUC_Job_List : System.Web.UI.UserControl
    {
        #region ****属性****
        ...
        public string SqlQuery
        {
            get
            {
                ...
                if (SearchKey != "") TempSql.Append(" and JobName like @SearchKey'");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select " + strSqlTop + " * from t_Job where IsClose=0 " + SqlQuery + " order by " + OrderField + " " + OrderKey + " " + strMySqlTop;
