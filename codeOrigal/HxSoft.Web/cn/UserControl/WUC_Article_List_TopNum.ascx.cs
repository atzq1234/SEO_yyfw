...
{
    public partial class WUC_Article_List_TopNum : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select " + strSqlTop + " * from t_Article where IsClose=0 " + strSql.ToString() + " order by " + OrderField + " " + OrderKey + " " + strMySqlTop;
