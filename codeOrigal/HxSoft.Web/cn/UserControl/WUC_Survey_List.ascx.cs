...
{
    public partial class WUC_Survey_List : System.Web.UI.UserControl
    {
        #region ****属性****
        ...
        public string SqlQuery
        {
            get
            {
                ...
                if (SearchKey != "") TempSql.Append(" and Subject like @SearchKey");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select " + strSqlTop + " * from t_Survey where IsClose=0 " + SqlQuery + " order by " + OrderField + " " + OrderKey + " " + strMySqlTop;
