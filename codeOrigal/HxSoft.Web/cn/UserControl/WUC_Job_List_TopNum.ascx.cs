...
{
    public partial class WUC_Job_List_TopNum : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           //
            ...
            string sql = "select " + strSqlTop + " * from t_Job where IsClose=0 " + strSql.ToString() + " order by " + OrderField + " " + OrderKey + " " + strMySqlTop;
