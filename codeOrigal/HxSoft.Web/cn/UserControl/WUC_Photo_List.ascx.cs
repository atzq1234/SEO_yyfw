...
{
    public partial class WUC_Photo_List : System.Web.UI.UserControl
    {
        #region ****属性****
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //列表绑定
            string sql = "select " + strSqlTop + " * from t_Photo where IsClose=0 " + SqlQuery + " order by " + OrderField + " " + OrderKey + " " + strMySqlTop;
