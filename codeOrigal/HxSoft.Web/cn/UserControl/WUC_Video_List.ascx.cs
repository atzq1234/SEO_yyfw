...
{
    public partial class WUC_Video_List : System.Web.UI.UserControl
    {
        #region ****属性****
        ...
        public string SqlQuery
        {
            get
            {
                ...
                if (SearchKey != "") TempSql.Append(" and Title like @SearchKey");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select " + strSqlTop + " * from t_Video where IsClose=0 " + SqlQuery + " order by " + OrderField + " " + OrderKey + " " + strMySqlTop;
