<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataStruct.aspx.cs" Inherits="HxSoft.Web.Common.DataStruct" %>
...
<option value="<%#Eval("Name") %>"><%#Eval("Name") %></option>
    ...
    <ItemTemplate>
  <div class="tb">表名:<%#Eval("Name") %><a name="<%#Eval("Name") %>"></a>&nbsp;&nbsp;&nbsp;<a href="#">TOP</a></div>
  <table cellspacing="1" cellpadding="5" border="0" width="100%">
    ...
    <tr class="td" onmouseover="this.className='over'" onmouseout="this.className='td'">
      <td><%#Eval("ColumnSort")%></td>
      <td><%#Eval("FieldName")%></td>
      <td><%#Eval("DataType")%></td>
      <td><%#Eval("Length")%></td>
      <td><%#Eval("DecimalDigit")%></td>
      <td><%#Eval("IsIdentity")%></td>
      <td><%#Eval("IsPrimaryKey")%></td>
      <td><%#Eval("IsNull")%></td>
      <td><%#Eval("DefaultValue")%></td>
      <td><%#Eval("ColumnDescription")%></td>
    </tr>
    </ItemTemplate>
    </asp:Repeater>
  </table>
