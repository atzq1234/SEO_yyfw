<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRank_SetLimit.aspx.cs" Inherits="HxSoft.Web.Admin.User.UserRank_SetLimit" %>
    ...
    <div id="container">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_form">
            ...
            <tr class="table_form_row">
                ...
                <td>
                    <asp:Label ID="lblUserRankName" runat="server"></asp:Label>
                </td>
            </tr>
            <tr class="table_form_row">
                <td style="width: 15%" align="right">
                    ...
                    <asp:DataList ID="DataList1" RepeatColumns="2" runat="server" OnItemDataBound="DataList1_ItemDataBound" Width="100%">
                        <ItemTemplate>
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_cancel">
                                <tr>
                                    <td>
                                        <input type="checkbox" name="LimitValue" id="Limit<%#Eval("LimitID") %>" value="<%#Eval("LimitValue") %>" <%#GetData.CheckUserRankLimitValue(UserRankID, Eval("LimitValue").ToString()) %> />
            ...
            <tr class="table_form_btn">
                ...
                <td colspan="3">
                    ...
                    <input type="button" name="Submit" value="返回" onclick="javascript:location.href='UserRank.aspx?<%=UrlOrderPara + UrlPara %>&page=<%=page %>';" />
