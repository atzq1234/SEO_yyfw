<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Photo_Add.aspx.cs" Inherits="HxSoft.Web.Admin.Photo.Photo_Add" %>
    ...
    <script language="javascript" type="text/javascript">
        $(function () {
            $("#btUpload1").click(function () {
                dialog("上传文件", "iframe:../Upload/File_Upload_Dialog.aspx?ObjName=txtSmallPic&FolderPath=<%=Config.FileUploadPath %>Photo/", "650px", "550px", "");
            });
            $("#btSelect1").click(function () {
                dialog("选择文件", "iframe:../Upload/File_Select_Dialog.aspx?ObjName=txtSmallPic&FolderPath=<%=Config.FileUploadPath %>Photo/", "650px", "550px", "");
            });
            ...
            $("#btUpload2").click(function () {
                dialog("上传文件", "iframe:../Upload/File_Upload_Dialog.aspx?ObjName=txtBigPic&FolderPath=<%=Config.FileUploadPath %>Photo/", "650px", "550px", "");
            });
            $("#btSelect2").click(function () {
                dialog("选择文件", "iframe:../Upload/File_Select_Dialog.aspx?ObjName=txtBigPic&FolderPath=<%=Config.FileUploadPath %>Photo/", "650px", "550px", "");
            });
    ...
    <div id="container">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_form">
            <tr class="table_form_title">
                <td colspan="4">
                    <asp:Label ID="lblTitle" runat="server">添加</asp:Label>相册
                </td>
            </tr>
            ...
            <tr class="table_form_row">
                ...
                <td>
                    ...
                    <asp:Label ID="Err" runat="server" Text="此路径下的图片已不存在,请重新上传" Font-Bold="true" ForeColor="Red" Visible="false"></asp:Label>
                </td>
            </tr>
            <tr class="table_form_row">
                <td style="width: 15%" align="right">
            ...
            <tr class="table_form_btn">
                ...
                <td colspan="3">
                    <asp:Button ID="Button1" runat="server" OnClick="btnSave_Click" Text="保存" />
