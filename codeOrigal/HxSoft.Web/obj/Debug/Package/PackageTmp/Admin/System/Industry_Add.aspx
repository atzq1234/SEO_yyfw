<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Industry_Add.aspx.cs" Inherits="HxSoft.Web.Admin._System.Industry_Add" %>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_form">
            ...
            <tr class="table_form_row">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtIndustryName" Display="Dynamic" ErrorMessage="不能为空" SetFocusOnError="True"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr class="table_form_row">
                <td style="width: 15%" align="right">
