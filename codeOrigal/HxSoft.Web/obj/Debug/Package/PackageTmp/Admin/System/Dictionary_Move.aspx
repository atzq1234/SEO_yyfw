<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dictionary_Move.aspx.cs" Inherits="HxSoft.Web.Admin._System.Dictionary_Move" %>
    ...
    <div id="container">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_form">
            ...
            <tr class="table_form_row">
                ...
                <td>
                    <asp:Label ID="lblDictionaryName" runat="server"></asp:Label>
