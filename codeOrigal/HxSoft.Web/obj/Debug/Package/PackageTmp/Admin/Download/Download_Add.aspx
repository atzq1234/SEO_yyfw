<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Download_Add.aspx.cs" Inherits="HxSoft.Web.Admin.Download.Download_Add" %>
    ...
    <script language="javascript" type="text/javascript">
        $(function () {
            $("#btUpload1").click(function () {
                dialog("上传文件", "iframe:../Upload/File_Upload_Dialog.aspx?ObjName=txtDownPic&FolderPath=<%=Config.FileUploadPath %>Download/", "650px", "550px", "");
            });
            $("#btSelect1").click(function () {
                dialog("选择文件", "iframe:../Upload/File_Select_Dialog.aspx?ObjName=txtDownPic&FolderPath=<%=Config.FileUploadPath %>Download/", "650px", "550px", "");
            });
            $("#btPreview1").click(function () {
                dialog("图片预览", "iframe:../Upload/File_Preview.aspx?FilePath=" + $("#txtDownPic").val(), "500px", "300px", "");
            });

            $("#btUpload2").click(function () {
                dialog("上传文件", "iframe:../Upload/File_Upload_Dialog.aspx?ObjName=txtDownUrl&FolderPath=<%=Config.FileUploadPath %>Download/", "650px", "550px", "");
            });
            $("#btSelect2").click(function () {
                dialog("选择文件", "iframe:../Upload/File_Select_Dialog.aspx?ObjName=txtDownUrl&FolderPath=<%=Config.FileUploadPath %>Download/", "650px", "550px", "");
            });
        });
    </script>
</head>
    ...
    <div id="container">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_form">
            <tr class="table_form_title">
                <td colspan="4">
                    <asp:Label ID="lblTitle" runat="server">添加</asp:Label>下载
                </td>
            </tr>
            ...
            <tr class="table_form_row">
                ...
                <td>
                    <asp:TextBox ID="txtDownName" runat="server" />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDownName" Display="Dynamic" ErrorMessage="不能为空" SetFocusOnError="True"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr class="table_form_row" style="display:none">
                ...
                <td>
                    <asp:TextBox ID="txtDownPic" runat="server" />
                    <input type="button" value="上传图片" id="btUpload1" />
                    <input type="button" value="上传图片" id="btSelect1" />
            ...
            <tr class="table_form_row">
                ...
                <td>
                    <asp:TextBox ID="txtDownUrl" runat="server" />
            ...
            <tr class="table_form_row">
                ...
                <td>
                    <asp:TextBox ID="txtDownSize" runat="server" />
                    (如为外部路径,请手动填写文件大小)
                </td>
            </tr>
            <tr class="table_form_row" style="display:none">
