<%@ Page Title="" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="survey_details.aspx.cs" Inherits="HxSoft.Web.cn.survey_details" %>
...
<%@ Register Src="UserControl/WUC_Survey_Details.ascx" TagName="WUC_Survey_Details" TagPrefix="uc4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="center">
        <div class="aboutMain">
            ...
            <div class="right">
                <div class="content">
                    <uc4:WUC_Survey_Details ID="WUC_Survey_Details1" runat="server" />
                </div>
            </div>
        </div>
    </div>
